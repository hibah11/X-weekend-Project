...
return(
    ...
    <div className =  ' px-20 bg-black text-white flex flex-row divide-x  divide-slate-700'>
        ...
        <div className = 'flex flex-row items-center gap-5'>
        <img className = 'w-6 h-7' src = {list}></img>
...
<button className = 'bg-[#1C9BEF] font-bold px-24 rounded-full py-3 text-lg'>Post</button>
        </div>
        
        <div className = 'flex flex-col py-3'>
            <div className = 'text-xl font-semibold px-4 pb-5'>
            Home
            </div>
...
<p className = 'px-32 py-4 hover:bg-zinc-900'>Following</p>
            ...
            <input className = 'bg-black text-xl border-none' type = 'text' placeholder = 'What is happening?!'></input>
        </div>
        ...
        <div className = 'flex flex-row justify-between items-center'>
            ...
            <button className = 'rounded-full bg-[#1C9BEF] mx-3 py-2 px-5'>Post</button>
        </div>
            </div>
        <div>
        ...
        <div className = 'flex flex-col px-10 pt-1 gap-10 items-center h-screen'>
...
<div className = 'bg-[#16181C] px-24 py-3 rounded-lg flex flex-col gap-10 flex flex-col  justify-center'>
